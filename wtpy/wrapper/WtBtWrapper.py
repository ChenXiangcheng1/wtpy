import os
from ctypes import POINTER, c_bool, c_char_p, c_double, c_int, c_uint32, c_uint64, c_ulong, cdll
...
from wtpy.WtCoreDefs import (
    ...
    CB_HFTSTRA_GET_ORDQUE,
    CB_HFTSTRA_GET_TRANS,
    CB_HFTSTRA_ORD,
    CB_HFTSTRA_ORDDTL,
    CB_HFTSTRA_ORDQUE,
    CB_HFTSTRA_TRANS,
    ...
    CB_STRATEGY_BAR,
    CB_STRATEGY_CALC,
    CB_STRATEGY_COND_TRIGGER,
    CB_STRATEGY_GET_BAR,
    CB_STRATEGY_GET_POSITION,
    CB_STRATEGY_GET_TICK,
    CB_STRATEGY_INIT,
    CB_STRATEGY_TICK,
    CHNL_EVENT_LOST,
    CHNL_EVENT_READY,
